...
hhvm -d extension_dir-../ -d hhvm.extensions[]=aerospike.so benchmark.php [-h<HOST IP ADDRESS>|--host=<HOST IP ADDRESS>
...
# Example 1: 
    ...
    To perform a total of 50000 reads and writes randomly in the ratio of 80:20,
...
# Example 2: 
    ...
    To perform a total of 50000 reads, execute the operations infinitely until externally stopped using "Ctrl+C",
